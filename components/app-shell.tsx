...
const manage = [
  { label: "Bank connections", href: "/dashboard", icon: CreditCard },
...
export function AppShell({
  ...
  return (
    <div className="min-h-screen bg-[#f4f5f3] text-[#17211d] lg:p-4">
      <div className="mx-auto flex min-h-screen max-w-[1500px] overflow-hidden border-[#e3e7e4] bg-white lg:min-h-[calc(100vh-2rem)] lg:rounded-[22px] lg:border lg:shadow-[0_18px_60px_rgba(25,46,38,0.08)]">
        <aside className="hidden w-[256px] shrink-0 flex-col border-r border-[#e4e7e5] bg-white p-5 lg:flex">
        ...
        <div className="min-w-0 flex-1 bg-[#fafbfa]">
